        ...
        <div className="container-fluid">
          ...
          {/* <!--/--> */}
                ...
                <ul className="navbar-nav ml-auto mr-auto">
                    <li className="nav-item dropdown">
                        ...
                        <ul className="dropdown-menu fade-up">
                            <li><a className="dropdown-item active" href="./index.html">Demo 1</a></li>
                            <li><a className="dropdown-item" href="./index-2.html">Demo 2 </a></li>
                            <li><a className="dropdown-item" href="./index-3.html">Demo 3 </a></li>
                            <li><a className="dropdown-item" href="./index-4.html">Demo 4 </a></li>
                            <li><a className="dropdown-item" href="./index-5.html">Demo 5</a></li>
                            <li><a className="dropdown-item" href="./index-6.html">Demo 6 </a></li>
                        </ul>
                    </li>
                    ...
                    <li className="nav-item dropdown">
                        ...
                        <ul className="dropdown-menu fade-up">
                            ...
                            <li><a className="dropdown-item" href="./page404.html"> Page 404 </a></li>
                        </ul>
                    </li>
            ...
            <div className="navbar-right ml-auto">
                ...
                {/* <!--search-icon--> */}
                <div className="search-icon"><i className="icon_search"></i></div>

                {/* <!--login-block--> */}
                <div className="login-block">
                    <a className="login-icon" href="./#"><i className="icon_profile"></i></a>
